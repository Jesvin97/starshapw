-- Mock Expenses Data for EV Wheels Business - Clean Version
-- This script safely handles expense_number conflicts by clearing test data first

-- Step 1: Remove existing test data to avoid conflicts
DELETE FROM public.expenses WHERE description LIKE '%[TEST]%';

-- Step 2: Insert fresh test data
...
-- Success message
SELECT 'Mock expense data inserted successfully! 27 test records added.' as result;
